                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless bg-white rounded small">
                            <thead class="border-bottom">
                                <tr>
                                    <th class="py-6 ps-6"><span class="btn p-0 d-flex align-items-center text-secondary pe-none">Employee Number</th>
                                    <th class="py-6 ps-6"><span class="btn p-0 d-flex align-items-center text-secondary pe-none">Name</th>
                                    <th class="py-6 ps-6"><span class="btn p-0 d-flex align-items-center text-secondary pe-none">Basic Income</th>
                                    <th class="py-6 ps-6"><span class="btn p-0 d-flex align-items-center text-secondary pe-none">Honorarium Income</th>
                                    <th class="py-6 ps-6"><span class="btn p-0 d-flex align-items-center text-secondary pe-none">Other Income</th>
                                    <th class="py-6 ps-6"><span class="btn p-0 d-flex align-items-center text-secondary pe-none">Gross Income</th>
                                    <th class="py-6 ps-6"><span class="btn p-0 d-flex align-items-center text-secondary pe-none">Total Deduction</th>
                                    <th class="py-6 ps-6"><span class="btn p-0 d-flex align-items-center text-secondary pe-none">Net Income</th>
                                    <th class="py-6 ps-6"><span class="btn p-0 d-flex align-items-center text-secondary pe-none">Paydate</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php

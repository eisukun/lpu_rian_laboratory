...
<body style="background:black url(Images/Assets/pattern.webp);">
    <div class="d-flex">
        <div class="vh-100 sticky-top" style="width: 280px;">
            <h5 class="text-white text-center my-5">Rian's Choice Enterprise</h5>
            <ul class="nav flex-column mb-auto">
                ...
                <li>
                    <a href="employee_registration_save.php" class="nav-link active mb-4">
            ...
            <div class="container">
                <div class="page_border">
                    <form id="pic-upload" class="a-form" enctype="multipart/form-data" method="post" width='840'>
                        <h1 style="text-align:center;  font-size:47px; color:black"><b>Rian's Employee Personal
                                Information</b></h1>

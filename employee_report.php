                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead class="border-bottom">
                                <tr>
                                    <th class="py-6 ps-6 border bg-dark"><span class="me-1 btn p-0 d-flex alig-items-center fw-bold pe-none text-white">Employee Number</span></th>
                                    <th class="py-6 ps-6 border bg-dark"><span class="me-1 btn p-0 d-flex alig-items-center fw-bold pe-none text-white">Employee Name</span></th>
                                    <th class="py-6 ps-6 border bg-dark"><span class="me-1 btn p-0 d-flex alig-items-center fw-bold pe-none text-white">Date of Birth</span></th>
                                    <th class="py-6 ps-6 border bg-dark"><span class="me-1 btn p-0 d-flex alig-items-center fw-bold pe-none text-white">Qual. Dependents</span></th>
                                    <th class="py-6 ps-6 border bg-dark"><span class="me-1 btn p-0 d-flex alig-items-center fw-bold pe-none text-white">Civil Status</span></th>
                                    <th class="py-6 ps-6 border bg-dark"><span class="me-1 btn p-0 d-flex alig-items-center fw-bold pe-none text-white">Department</span></th>
                                    <th class="py-6 ps-6 border bg-dark"><span class="me-1 btn p-0 d-flex alig-items-center fw-bold pe-none text-white">Designation</span></th>
                                    <th class="py-6 ps-6 border bg-dark"><span class="me-1 btn p-0 d-flex alig-items-center fw-bold pe-none text-white">Employee Status</span></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
